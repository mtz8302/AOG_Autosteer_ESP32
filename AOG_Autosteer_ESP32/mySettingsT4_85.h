...
//NETWORK 
  ...
  //WiFi
  #define WIFI_SSID "T4.85_WLAN"                // WiFi network Client name
  #define WIFI_PASSWORD "T4.85_WLAN"            // WiFi network password
  #define WIFI_SSID_AP "Autosteer_Unit_T4.85"   // name of Access point, if no WiFi found, NO password!!
