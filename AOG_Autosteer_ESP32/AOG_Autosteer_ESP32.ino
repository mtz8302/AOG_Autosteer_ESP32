...
byte patch_level_ver_nr = 5; //increase during bug fixing and development until minor-version step
char VersionTXT[120] = "11. Sept. 2021 by MTZ8302 + hagre";
...
bool calibrateStepsPerDegree = false;
